-- Adiciona aplicações "Robô Logistica", "Monitoramento de Fornos" e "Monitoramento Autoclaves" na aba Aplicações
...
-- Inserir aplicação "Robô Logistica"
...
-- Inserir aplicação "Monitoramento de Fornos"
INSERT INTO maestro_portal_applications (key, name, description, url, active)
VALUES (
...
-- Inserir aplicação "Monitoramento Autoclaves"
INSERT INTO maestro_portal_applications (key, name, description, url, active)
VALUES (
